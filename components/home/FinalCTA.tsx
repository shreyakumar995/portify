...
export default function FinalCTA({
  ...
  return (
    <section
      ...
      className="home-cta-section relative overflow-hidden border-t border-[var(--home-border-subtle)] py-20 sm:py-24 lg:py-28 xl:py-32"
    >
            ...
            <div className="flex flex-col gap-2.5 sm:flex-row sm:justify-center">
              <div className="relative flex-1 sm:max-w-[240px]">
                ...
                <input
                  ...
                  autoComplete="off"
                  spellCheck={false}
                  className="home-input home-input-compact bg-[var(--home-input-bg)]"
                />
              </div>
              <button
                type="submit"
